...
public class OracleDialect extends AbstractDialect {
	...
	public DBDateInfo getDateFormat() {
		DBDateInfo dateInfo = new DBDateInfo("yyyy", "mm", "dd", "hh24", "mi", "ss");
		dateInfo.setToCharMethod("TO_CHAR");
		dateInfo.setToDateMethod("TO_DATE");
		dateInfo.setSysDateMethod("SYSDATE");
		return dateInfo;
	}
