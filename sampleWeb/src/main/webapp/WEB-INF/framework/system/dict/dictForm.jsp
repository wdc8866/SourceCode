	...
	<body class="no-skin">
		...
		<div class="widget-box transparent ui-sortable-handle" id="widget-box-search">
			<div class="widget-header">
				<h3 class="widget-title smaller lighter">&nbsp;数据字典${not empty dictModel.id?'修改':'新增'}</h3>
			...
			<div class="widget-body">
				...
				<div class="widget-main padding-6 no-padding-left no-padding-right">
					...
					<form:form id="inputForm" modelAttribute="dictModel" action="${path}/sys/dict/save" method="post" class="form-horizontal" htmlEscape="false">
						<form:hidden path="id"/>
						...
						<div class="row">
							<div class="form-group-2">
								...
								<div class="col-sm-3">
									...
									<form:input path="parent.label" htmlEscape="false" maxlength="50" cssClass="form-control" readonly="true"/>
								</div>
							</div>
							<div class="form-group-2">
								<label class="col-sm-2 control-label no-padding-right">字典名称:</label>
								<div class="col-sm-3">
						...
						<div class="row">
							<div class="form-group-2">
								...
								<div class="col-sm-3">
									<form:input path="value" htmlEscape="false" maxlength="200" cssClass="form-control"/>
								</div>
							</div>
							<div class="form-group-2">
								<label class="col-sm-2 control-label no-padding-right">字典类型:</label>
								<div class="col-sm-3">
									<form:input path="type" htmlEscape="false" maxlength="50" cssClass="form-control"/>
								</div>
							</div>
						</div>
						<div class="space-4"></div>
						<div class="row">
							<div class="form-group-2">
								<div class="form-group-2">
									...
									<div class="col-sm-3">
										<form:input path="sort" htmlEscape="false" maxlength="50" cssClass="form-control"/>
									</div>
								</div>
							</div>
						</div>
